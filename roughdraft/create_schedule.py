...
def course_scheduler(prerequisites, final_courses, prereqs_df, difficulties_df, chosen_capstone_courses): 
...
course_scheduler(prerequisites, final_courses, prereqs_df, difficulties_df, chosen_capstone_courses)
